            ...
            <div class="space-y-6">
                ...
                <div class="group bg-white/80 backdrop-blur-md shadow-xl rounded-[30px] border border-green-100 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-200/50 hover:border-emerald-400">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="flex items-center justify-between p-2 rounded-2xl hover:bg-emerald-50/50 transition-colors">
                            <div>
                                <p class="font-bold text-gray-700">Email Notifikasi</p>
                                <p class="text-xs text-gray-400 font-medium">Terima ringkasan kehadiran mingguan melalui email.</p>
                            </div>
                ...
                <div class="group bg-white/80 backdrop-blur-md shadow-xl rounded-[30px] border border-green-100 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-200/50 hover:border-emerald-400">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-center justify-between p-2 rounded-2xl hover:bg-emerald-50/50 transition-colors">
                            <div>
                                <p class="font-bold text-gray-700">Profil Publik</p>
                                <p class="text-xs text-gray-400 font-medium">Izinkan karyawan lain melihat status kehadiran Anda.</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
