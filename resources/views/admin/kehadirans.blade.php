    ...
    <div class="relative z-10 py-12 min-h-screen" x-data="{ 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-[35px] border border-emerald-100 overflow-hidden shadow-2xl">
                <form action="{{ route('admin.kehadirans') }}" method="GET" class="p-6 bg-emerald-50/50 border-b border-emerald-100 flex justify-between items-center">
                    <div class="flex gap-4">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama karyawan..." class="border-emerald-200 rounded-xl text-sm w-64">
                        <input type="date" name="date" value="{{ request('date') }}" class="border-emerald-200 rounded-xl text-sm">
        ...
        <div x-show="openAdd" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" x-cloak>
            <div class="bg-white rounded-[35px] w-full max-w-md p-8 shadow-2xl max-h-[90vh] overflow-y-auto border border-emerald-100">
                ...
                <div class="mb-4">
                    ...
                    <div id="map-container" class="w-full h-40 rounded-2xl border border-emerald-100 bg-gray-50"></div>
                </div>
                <form action="{{ route('admin.kehadirans.store') }}" method="POST">
                    ...
                    <div class="mt-8 flex gap-3">
                        ...
                        <button type="submit" :disabled="isOutOfRange" :class="isOutOfRange ? 'bg-gray-300 cursor-not-allowed' : 'bg-emerald-600 shadow-emerald-200'" class="flex-1 py-4 text-white rounded-2xl text-xs font-black uppercase shadow-lg">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div x-show="openEdit" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" x-cloak>
            <div class="bg-white rounded-[35px] w-full max-w-md p-8 shadow-2xl max-h-[90vh] overflow-y-auto border border-emerald-100">
                ...
                <div class="mb-4">
                    ...
                    <div id="map-edit-container" class="w-full h-40 rounded-2xl border border-amber-100 bg-gray-50"></div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-3 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
                             ...
                             <div class="flex justify-between text-[10px] font-mono text-gray-500">
                                 <span>Masuk: <span x-text="currentData.ip_address_masuk || 'N/A'"></span></span>
                                 <span>Pulang: <span x-text="currentData.ip_address_pulang || 'N/A'"></span></span>
                             </div>
                        </div>
                    </div>
                    <div class="mt-8 flex gap-3">
        ...
        <div x-show="openDelete" class="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" x-cloak>
            <div class="bg-white rounded-[35px] w-full max-w-sm p-8 shadow-2xl text-center border border-rose-100">
                ...
                <p class="text-gray-500 text-xs mb-8">Data yang dihapus tidak dapat dikembalikan.</p>
